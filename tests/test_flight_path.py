...
def flight_graph():
    """Fixture for graph."""
    from src.flight_path import make_airport_graph, parse_data_into_required_format, get_data_from_json_file
...
#     """Test data from src.json url is in a list with length."""
#     from src.flight_path import get_data_from_json_url
#     data = get_data_from_json_url()
#     assert len(data) == 741


# def test_get_data_from_file_returns_list():
#     """Test data from src.json file is in a list."""
...
def test_parse_data_into_required_format():
    ...
    from src.flight_path import parse_data_into_required_format
    data = [
        {"city": "Goma",
         "connection_urls": [
...
def test_flight_path_shortest_path_no_connections(flight_graph):
    ...
    from src.flight_path import return_shortest_route
